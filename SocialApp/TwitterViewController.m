...
@interface TwitterViewController ()<TwitterAPIDelegate>
{
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    //[self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"twitterstrip.png"] forBarMetrics:UIBarMetricsDefault];
    if (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7.0"))
    {
        [self customizeNavigationControllerWith:[UIColor colorWithRed:113/255.0f green:217/255.0f blue:252/255.0f alpha:1] andImage:@"twitterstrip.png"];
    }
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    titleLabel.text  =[[self.listArray objectAtIndex:indexPath.row] valueForKey:@"title"];
    [titleLabel setFrame:CGRectMake(0, 5, 310, 62)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   // cell.bodyTextView.dataDetectorTypes = UIDataDetectorTypeAddress | UIDataDetectorTypeLink | UIDataDetectorTypePhoneNumber;
    ...
    [subTitleLabel setFrame:CGRectMake(8, titleLabel.frame.origin.y+titleLabel.frame.size.height, 310, 21)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    /*NSString *str = [[self.listArray objectAtIndex:indexPath.row] valueForKey:@"link"];
