...
@interface NewsViewController ()<NewsXmlParserDelegate>
{
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    //[self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"newsstrip"] forBarMetrics:UIBarMetricsDefault];
    //Amar changes
    if(SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7.0f"))
    {
        [self customizeNavigationControllerWith:[UIColor colorWithRed:240/255.0f green:134/255.0f blue:49/255.0f alpha:1] andImage:@"newsstrip"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    newsDetailVC.backgroundColor = [UIColor colorWithRed:240/255.0f green:134/255.0f blue:49/255.0f alpha:1];
    newsDetailVC.imgName = @"newsstrip";
