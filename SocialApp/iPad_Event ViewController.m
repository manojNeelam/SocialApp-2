...
@interface iPad_Event_ViewController () <EventXmlParserDelegate>
{
...
@implementation iPad_Event_ViewController
...
- (void)viewDidLoad
{
    ...
    if (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7.0"))
    {
        ...
        //view.backgroundColor =[UIColor colorWithRed:0/255.0f green:153/255.0f blue:76/255.0f alpha:1];
        
        view.backgroundColor =[UIColor colorWithRed:4/255.0f green:161/255.0f blue:110/255.0f alpha:1];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"eventstrip~ipad.png"] forBarMetrics:UIBarMetricsDefault];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [titleLabel setFrame:CGRectMake(20, 10, 618, 62)];
    ...
    UIImageView *imagView = [[UIImageView alloc] initWithFrame:CGRectMake(628, 5, 120, 89)];
    ...
    if(![url isEqualToString:@""])
    {
        ...
        [imagView setImageWithURL:[NSURL URLWithString:url] success:^(UIImage *image, BOOL cached) {
            if(imageview)
            {
    ...
    else
    {
        ...
        [subTitleLabel setFrame:CGRectMake(20, titleLabel.frame.origin.y+titleLabel.frame.size.height+10, 728, 21)];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   /*
    ...
    iPad_News_detailViewController *newsDetailVC = [strotyBoard instantiateViewControllerWithIdentifier:@"iPad_News detailViewController"];
