...
#import "iPad_You tubeViewController.h"
...
@interface iPad_You_tubeViewController ()<YoutubeXmlParserDelegate>
{
...
@implementation iPad_You_tubeViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"youtubestrip~ipad.png"] forBarMetrics:UIBarMetricsDefault];
    ...
    [NSURLConnection sendAsynchronousRequest:request
     ...
     
     {
         ...
         if(itemsList.count)
         {
             ...
             [youtubeCoreService saveYoutubeListFromJson:array];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(![url isEqualToString:@""])
    {
        ...
        CGSize maximumLabelSize = CGSizeMake(618, FLT_MAX);
        ...
        [subTitleLabel setFrame:CGRectMake(20, titleLabel.frame.origin.y+titleLabel.frame.size.height+10, 618, 21)];
    }
    else
    {
        [imagView setAlpha:0];
        ...
        CGSize maximumLabelSize = CGSizeMake(728, FLT_MAX);
        CGSize expectedLabelSize = [titleLabel.text sizeWithFont:titleLabel.font
                                               constrainedToSize:maximumLabelSize
                                                   lineBreakMode:NSLineBreakByCharWrapping];
        CGRect newFrame = titleLabel.frame;
